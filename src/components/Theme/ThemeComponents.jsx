...
export function ThemeComponents() {
  ...
  return {
    ...
    page: `min-h-screen transition-colors ${darkMode ? "bg-[#020617] text-[#F8FAFC]" : "bg-[#F8FAFC] text-[#020617]"}`,
    section: `transition-colors ${darkMode ? "bg-[#020617] text-[#F8FAFC]" : "bg-[#F8FAFC] text-[#020617]"}`,
    sectionAlt: `transition-colors ${darkMode ? "bg-[#0F172A] text-[#F8FAFC]" : "bg-[#FFFFFF] text-[#020617]"}`,
    ...
    header: `border-b backdrop-blur-xl ${
      darkMode ? "border-white/10 bg-[#020617]/90 text-[#F8FAFC]" : "border-[#E2E8F0] bg-[#FFFFFF]/90 text-[#020617]"
    }`,
    footer: `border-t text-white ${darkMode ? "border-white/10 bg-[#020617]" : "border-[#E2E8F0] bg-[#0F172A]"}`,
    ...
    card: `rounded-2xl border shadow-sm transition-colors ${
      darkMode ? "border-white/10 bg-[#0F172A] text-[#F8FAFC]" : "border-[#E2E8F0] bg-[#FFFFFF] text-[#020617]"
    }`,
    cardHover: darkMode
    ...
    buttonSuccess: darkMode ? "bg-green-600 text-white hover:bg-green-500" : "bg-green-600 text-white hover:bg-green-500",
    buttonWarning: darkMode ? "bg-amber-500 text-white hover:bg-amber-400" : "bg-amber-600 text-white hover:bg-amber-500",
    buttonError: darkMode ? "bg-red-500 text-white hover:bg-red-400" : "bg-red-600 text-white hover:bg-red-500",
    ...
    navBg: darkMode ? "bg-slate-800 text-white hover:bg-slate-700" : "bg-slate-200 text-slate-600 hover:bg-slate-300",
    badge: `inline-flex rounded-full border px-4 py-2 text-sm font-bold ${
      darkMode ? "border-cyan-400/20 bg-cyan-400/10 text-cyan-200" : "border-cyan-200 bg-cyan-50 text-cyan-700"
    }`,
    focus: darkMode
    ...
    iconButton: "grid h-10 w-10 place-items-center rounded-xl border border-theme-border transition hover:border-theme-primary",
    ...
    sidebar:
      `fixed inset-y-0 left-0 z-50 flex w-72 -translate-x-full flex-col border-r border-theme-border pt-4 shadow-2xl transition-all duration-300 lg:top-[65px] lg:z-30 lg:translate-x-0 lg:shadow-none ${
